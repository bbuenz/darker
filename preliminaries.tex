...
The \defn{$r$-Fractional Root Assumption} holds for $\ggen$ if taking $r$th root is easy for any efficient adversary $\adv$:
\[        
...
We modify and weaken the Strong RSA Assumption such that it explicitly allows an adversary to take square roots (and higher power of $2$ roots).
