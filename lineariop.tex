...
A public-coin $(\mu, d)$ Polynomial IOP is a public-coin algebraic linear IOP where each query-response $\langle \boldsymbol{\pi}_i , \mathbf{Q}_{i} \rangle$ corresponds to the evaluation of some polynomial $f \in \mathbb{F}^\mu$ in the seed vector $\boldsymbol{\sigma_i}$.
\end{definition}
