...
\begin{tabular}{l||l|l|l|l|l|l}
	...
	\hline
	\hline
    \textsf{Supersonic} & yes & $O(1)$ & $O( n \log(n) )\; \textsf{EXP}$ & $O(\log(n))~\textsf{EXP}$ & $O(\log(n) \ \GG_{U})$ & 7.8KB \\
