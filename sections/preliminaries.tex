...
First, the famous RSA Assumption~\cite{RivShaAdl78} which states that it is hard to take \emph{random} roots of \emph{random} elements. Secondly, the much newer Adaptive Root Assumption~\cite{EC:Wesolowski19} which is the dual of the Strong RSA Assumption and states that it is hard to take \emph{random} roots of \emph{arbitrary} group elements. 
