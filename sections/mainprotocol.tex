...
\begin{tabular}{l||l|l|l|l|l}
	...
	\hline
	\hline
    DARK  & yes & $O(1)$ & $O( d^\mu \mu \log(d) )\; \textsf{EXP}$ & $2\mu \log(d)~\textsf{EXP}$ & $2 \mu \log(d) \GG_{U}$ \\
...
In particular we evaluate the reference string size, the prover and verifier time as well as the evaluation proof size.
