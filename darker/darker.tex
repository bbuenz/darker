...
\begin{flalign*}
(\alpha_2 - \alpha_1) \cdot ( f_E^{(i)} \cdot \mathsf{G} + \mathsf{W}_E^{(i)} ) = \\
 ( \alpha_2 f_1^{(i+1)} - \alpha_1 f_2^{(i+1)} ) \cdot \mathsf{G} + \alpha_2 \cdot \mathsf{W}_1 - \alpha_1 \cdot \mathsf{W}_2 \enspace .
\end{flalign*}
...
\begin{flalign*}
a_E^{(i)} \cdot (\alpha_2 - \alpha_1) \cdot f_E^{(i)} \cdot \mathsf{G} = \\
 a_E^{(i)} \cdot ( \alpha_2 f_1^{(i+1)} - \alpha_1 f_2^{(i+1)} ) \cdot \mathsf{G} \enspace .
\end{flalign*}
