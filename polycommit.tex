...
This version of the paper includes a new security proof. The original proof had a significant gap that was discovered by Block et all (CRYPTO 2021). The new security proof closes the gap and shows that the original protocol with a slightly adjusted parameter is still secure. The new security proof has implications for the security of the Fiat-Shamir transform which we discuss in detail.
...
\benedikt{Make sure to properly acknowledge the person who found the bug and Katharina who pointed out the multivariate issue.}
