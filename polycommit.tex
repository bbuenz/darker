...
\begin{document}
\title{\pro{Supersonic}: Transparent SNARKs from DARK Arguments}
\maketitle
...
As discussed it has highly batchable proofs and it is possible to evaluate $n$ degree $d$ polynomials at $m$ points using only $2\log_2(d+1)$ group elements and $(m+1)\log_2(d+1)$ field elements.
...
\ben{@Benedikt, there is discrepancy here in some numbers} 
